...
This folder contains lightweight references for the external benchmark datasets used in the project.

## Included Files

- `MANIFEST.json`: recorded external dataset manifest
- `DATASET_INDEX.md`: human-readable dataset index
- `DATASET_INDEX.json`: machine-readable dataset index
